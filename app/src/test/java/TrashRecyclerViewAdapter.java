...
import com.example.finalwork.CustomAdapter;
import com.example.finalwork.R;
import com.example.finalwork.UpdateActivity;

import java.util.ArrayList;

public class TrashRecyclerViewAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder>{
    ...
    TrashRecyclerViewAdapter(Activity activity, Context context, ArrayList text_id, ArrayList text_type,
